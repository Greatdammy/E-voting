...
public class VoteServiceTests
{
    ...
    public async Task CastVoteAsync_Succeeds_WhenElectionActiveAndVoterHasNotVoted()
    {
        ...
        var request = new CastVoteRequestDto { CandidateId = candidate.CandidateId };
    ...
    public async Task CastVoteAsync_ReturnsNotFound_WhenElectionDoesNotExist()
    {
        ...
        var result = await _sut.CastVoteAsync(electionId, Guid.NewGuid(), new CastVoteRequestDto { CandidateId = Guid.NewGuid() });
    ...
    public async Task CastVoteAsync_ReturnsElectionNotActive_WhenElectionIsUpcoming()
    {
        ...
        var result = await _sut.CastVoteAsync(election.ElectionId, Guid.NewGuid(), new CastVoteRequestDto { CandidateId = Guid.NewGuid() });
    ...
    public async Task CastVoteAsync_ReturnsInvalidCandidate_WhenCandidateBelongsToDifferentElection()
    {
        ...
        var result = await _sut.CastVoteAsync(election.ElectionId, Guid.NewGuid(), new CastVoteRequestDto { CandidateId = candidate.CandidateId });
    ...
    public async Task CastVoteAsync_ReturnsAlreadyVoted_WhenVoterElectionStatusHasVoted()
    {
        ...
        var result = await _sut.CastVoteAsync(election.ElectionId, voterId, new CastVoteRequestDto { CandidateId = candidate.CandidateId });
